...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="{{ url('admin/product/store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="supplier_cat" name="supplier_cat">
                            ...
                            @foreach ($supplier as $sup)
                                <option value="{{ $sup->id }}" {{ old('supplier_cat') == $sup->id ? 'selected' : '' }}>
                                    {{ $sup->name }}
                                </option>
                            @endforeach
                        </select>
