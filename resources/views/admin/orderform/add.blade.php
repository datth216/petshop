...
@section('content')
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ url('admin/orderform/store') }}" id="test1">
                    @csrf       
                    ...
                    {{--  <div class="form-group">
                        ...
                        <select class="form-control product_cat" id="product_cat" name="product_cat" data-dependent="product_cat">
